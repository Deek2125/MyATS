...
<html lang="en">
    ...
    <style>
      ...
      background-image:url('C:\xampp\htdocs\ats\alumni\alumni\admin\assets\uploads\1704453360_alumnitracking.jpg')
...
a.jqte_tool_label.unselectable {
    ...
    <body id="page-top" >
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="./"><font face="Georgia, serif"><font color="#00FFFF">A</font>lumni<font color="#00FFFF">E</font>dition</font></a>
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5" >
            ...
            <div class="container"><div class="small text-center text-muted">Copyright ©Deekshitha - <?php echo $_SESSION['system']['name'] ?> | <a href="https://vvce.ac.in/" target="_blank">VVCE</a></div></div>
        </footer>
