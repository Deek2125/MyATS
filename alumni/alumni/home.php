    ...
    <div class="container-fluid h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            <div class="col-lg-8 align-self-end mb-4 page-title">
                <h3 class="text-white">
                    <font color="#E0FFFF"><strong>Welcome to</strong></font>
                    <font color="#B8860B">
                        <font face="Serif"><strong>AlumniEdition</strong></font>
                    </font>
                </h3>
...
<div class="container mt-3 pt-2" style="background-color:#000000">
    <h4 class="text-center text-white"><em>
            <font face="Cursive">
                <marquee behavior="alternate">Your story.....our exclusive <font color="B8860B">edition!</marquee>
            </font>
        </em></h4>
    <hr class="divider">
    <?php
            ...
            <div class='banner'>
                <?php if (!empty($row['banner'])): ?>
                    <img src="admin/assets/uploads/<?php echo ($row['banner']) ?>"
                        alt="C:\xampp\htdocs\alumni\admin\assets\uploads\1602738120_pngtree-purple-hd-business-banner-image_5493 (2).jpg">
                <?php endif; ?>
            </div>
            <div class="card-body">
