                            ...
                            <div class="row form-group">
                                <div class="col-md-4">
                                    ...
                                    <select class="custom-select" name="gender" required>
                                        <option <?php echo $_SESSION['bio']['gender'] == 'Male' ? 'selected' : '' ?>>Male
                                        </option>
                                        <option <?php echo $_SESSION['bio']['gender'] == 'Female' ? 'selected' : '' ?>>
                                            Female</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="custom-select select2" name="course_id" required>
                                        ...
                                        while ($row = $course->fetch_assoc()):
                                            ?>
                                            <option value="<?php echo $row['id'] ?>" <?php echo $_SESSION['bio']['course_id'] == $row['id'] ? 'selected' : '' ?>>
                                                <?php echo $row['course'] ?>
                                            </option>
                                        <?php endwhile; ?>
                                    </select>
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="linkedin" class="form-control" name="linkedin"
                                            value="<?php echo $_SESSION['bio']['linkedin'] ?>" required>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label for="" class="control-label">Skills</label>
                                            <input type="Skills" class="form-control" name="Skills"
                                                value="<?php echo $_SESSION['bio']['Skills'] ?>" required>
                                        </div>

                                        <div class="col-md-4">
                                            <label for="" class="control-label">Password</label>
                                            <input type="password" class="form-control" name="password">
                                            <small><i>Leave this blank if you dont want to change your
                                                    password</i></small>
                                        </div>
                                    </div>
                                    <div id="msg">
