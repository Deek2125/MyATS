    ...
    <div class="container-fluid h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            <div class="col-lg-8 align-self-end mb-4 page-title">
                <h3 class="text-white">
                    <font face=serif>List of Alumnus/Alumnae
                </h3>
    ...
    <div class="row-items">
        <div class="col-lg-12">
            <div class="row">
                ...
                $alumni = $conn->query("SELECT a.*,c.course,Concat(a.firstname,' ',a.lastname,' ',a.middlename) as name from alumnus_bio a inner join courses c on c.id = a.course_id order by Concat(a.lastname,', ',a.firstname,' ',a.middlename) asc");
                                    ...
                                    <div class="">
                                        <div>
                                            <p class="filter-txt"><b>
                                                    <?php echo $row['name'] ?><i class="fa fa-check-circle"
                                                        aria-hidden="true"></i>
                                            ...
                                            <p class="filter-txt">Linkedin<b>
                                                    <?php echo $row['link'] ?>
                                                </b></p>
                                            <p class="filter-txt">Skills:<b>
                                                    <?php echo $row['Skills'] ?>
                                                </b></a></p>
                                            ...
                                            <p class="filter-txt">Currently working in/as <b>
                                                    ...
                                                    <button style="color:blue"><a href="review.php">Review
                                                            here</a></button>
                                                </b></p>
